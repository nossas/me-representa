Feature: Post my own question
  ...
  Scenario: when I post a truth
    ...
    And I fill in "Sim ou Não? Você..." with "você é a favor da liberação da maconha?"
    ...
    And I should see Sim ou Não? Você você é a favor da liberação da maconha?
  ...
  Scenario: when I post a dare
    Given I'm logged in
    And I go to the questions page
    And I fill in "Você se comprometerá a..." with "instalar 10 novas paradas de onibus na Glória"
    And I choose "Saúde e Drogas" for "Assunto"
    And I press "Pré-visualizar"
    When I press "Confirmar"
