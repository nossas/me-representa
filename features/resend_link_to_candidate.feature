Feature: Receive link to participate
  ...
  Scenario: When I haven't my cellphone and my email registered
    ...
    When I click "Quer participar? Não recebeu seu questionário? Clique aqui para solicitar o reenvio!"
    ...
    And I fill in "Insira seu telefone" with "5555555555"
    And I choose "PT" for "Partido"
